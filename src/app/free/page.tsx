  ...
  return (
    <main className='min-h-screen p-6 max-w-7xl mx-auto'>
      <div className='mb-6 flex items-start justify-between gap-4 flex-wrap'>
        <div>
          ...
          <p className='text-gray-400 mt-1 text-sm max-w-2xl leading-relaxed'>
            ...
            <span className='text-yellow-400'>免费不等于稳定</span>
            ，请合理使用、不要刷量，
            为站长留点服务器钱，让公益走得更远。
          </p>
        </div>
      ...
      <div className='grid grid-cols-2 md:grid-cols-3 gap-3 mb-6'>
        <StatCard label='公益站数' value={rows.length} accent='text-blue-400' />
        <StatCard label='当前在线' value={online} accent='text-green-400' />
        <StatCard
          label='收录占比'
      ...
      <div className='mt-8 border border-gray-800 rounded-lg p-5 bg-gray-900/30 text-sm text-gray-400 leading-relaxed'>
        <h3 className='text-gray-200 font-medium mb-2'>给公益站长的话</h3>
        <p>
