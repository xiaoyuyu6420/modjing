  ...
  return (
    <main className='min-h-screen p-6 max-w-7xl mx-auto'>
      <div className='mb-6 flex items-start justify-between gap-4 flex-wrap'>
        <div>
          <h1 className='text-3xl font-bold'>中转站列表</h1>
      ...
      <div className='grid grid-cols-2 md:grid-cols-4 gap-3 mb-6'>
        ...
        <StatCard label='在线' value={online} accent='text-green-400' />
        <StatCard label='公益站' value={free} accent='text-blue-400' />
        <StatCard label='支持发票' value={invoice} accent='text-purple-400' />
      </div>
